...
(function ($) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'O arquivo "{name}" (<b>{size} KB</b>) excedeu o limite maximo: <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Você precisa selecionar ao menos  um <b>{n}</b> {files} para enviar.',
        msgFilesTooMany: 'O número de arquivos selecionados <b>({n})</b> excedeu o limite máximo <b>{m}</b>.',
        msgFileNotFound: 'Arquivo "{name}" não encontrado!',
        msgFileSecured: 'Security restrictions prevent reading the file "{name}".',
        msgFileNotReadable: 'File "{name}" is not readable.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'An error occurred while reading the file "{name}".',
        msgInvalidFileType: 'Tipo inválido "{name}". Apenas "{types}" são permitidos.',
        msgInvalidFileExtension: 'Extensão inválida "{name}". Apenas "{extensions}" são permitidas.',
        msgUploadAborted: 'Carregamento do arquivo foi abortado',
        msgValidationError: 'Erro ao carregar',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} selected',
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: 'A largura da imagem "{name}" deve ter pelo menos {size} px.',
        msgImageHeightSmall: 'A altura da imagem "{name}" deve ter pelo menos {size} px.',
        msgImageWidthLarge: 'A largura "{name}" deve ter no máximo {size} px.',
        msgImageHeightLarge: 'A altura "{name}" deve ter no máximo {size} px.',
